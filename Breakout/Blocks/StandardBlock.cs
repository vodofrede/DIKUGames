...
namespace Breakout.Blocks {
    public class StandardBlock : Entity {
        ...
        public StandardBlock(Vec2F pos, string imageName) : base(new StationaryShape(new Vec2F(pos.X / HORIZONTALBLOCKS, 1f - pos.Y / VERTICALBLOCKS), new Vec2F(1f / 12f, 1f / 25f)), new Image(Path.Combine("Assets", "Images", imageName))) {
            Hitpoints = 1;
            Value = 1;
            Type = "Block";
        }
